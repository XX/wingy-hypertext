...
fn default() {
    let switch_markup = format!(
        r#"<div class="switch"><label><input class="control" type="checkbox" role="switch">{TRACK_MARKUP}<span class="label"></span></label></div>"#
    );
...
fn label() {
    let switch_markup = format!(
        r#"<div class="switch"><label><input class="control" type="checkbox" role="switch">{TRACK_MARKUP}<span class="label">Enable notifications</span></label></div>"#
    );
...
fn hint() {
    let switch_markup = format!(
        r#"<div class="switch"><label><input class="control" type="checkbox" role="switch">{TRACK_MARKUP}<span class="label">Email me about new releases</span></label><small class="hint">You can change this at any time.</small></div>"#
    );
...
fn states() {
    let switch_markup = format!(
        r#"<div class="switch"><label><input class="control" type="checkbox" role="switch" checked="true">{TRACK_MARKUP}<span class="label"></span></label></div>"#
    );
...
fn name_and_value() {
    let switch_markup = format!(
        r#"<div class="switch"><label><input class="control" type="checkbox" role="switch" name="notifications" value="enabled" checked="true">{TRACK_MARKUP}<span class="label"></span></label></div>"#
    );
...
fn additional_attributes() {
    let switch_markup = format!(
        r#"<div id="the-switch" class="switch test" style="--width: 80px"><label><input class="control" type="checkbox" role="switch">{TRACK_MARKUP}<span class="label"></span></label></div>"#
    );
